...
import { AvailableMenus, openMenu, selectLayers, selectMenu, selectSearch, toggleLayers, toggleSearch } from "../../app/store/slices/settingSlice";
...
const MapToolbar = () => {
    ...
    },
    {
        ...
        icon: Eye,
        label: "Vues",
        action: () => dispatch(openMenu(AvailableMenus.VIEW)),
        active: currentOpenedMenu === AvailableMenus.VIEW
    },
    {
        id: "export",
        icon: Download,
    ...
    {/* <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[1000] w-full max-w-4xl px-4"> */}
        ...
        {scrollPosition > 0 && (
            ...
            className="absolute z-10 p-1 transform -translate-y-1/2 bg-white rounded-full shadow-md left-1 top-1/2 dark:bg-slate-700"
            >
        ...
        <button
            ...
            className="absolute z-10 p-1 transform -translate-y-1/2 bg-white rounded-full shadow-md right-1 top-1/2 dark:bg-slate-700"
        >
